...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "autotest-fsevent.gemspec", "lib/autotest-fsevent.rb", "lib/autotest/fsevent.rb", "script/console", "script/destroy", "script/generate", "spec/autotest-fsevent_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "tasks/rspec.rake", "ext/fsevent/extconf.rb"]
...
[0m
  ...
  s.require_paths = ["lib", "ext/fsevent"]
